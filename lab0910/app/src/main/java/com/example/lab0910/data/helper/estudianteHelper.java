...
public class estudianteHelper extends ItemTouchHelper.SimpleCallback{
    private estudianteHelper.RecyclerItemTouchHelperListener listener;
    private View foregroundView;
    private View backgroundViewEdit;
    private View backgroundViewDelete;
    private int dragColor = Color.rgb(102, 102, 255);

    public estudianteHelper(int dragDirs, int swipeDirs, estudianteHelper.RecyclerItemTouchHelperListener listener) {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (viewHolder != null) {
            //check adapter
            if (this.listener.getClass().getSimpleName().equals("listEstudiante")) {
                backgroundViewEdit = ((AdapterEstudiante.MyViewHolder) viewHolder).viewBackgroundEdit;
                backgroundViewDelete = ((AdapterEstudiante.MyViewHolder) viewHolder).viewBackgroundDelete;
                foregroundView = ((AdapterEstudiante.MyViewHolder) viewHolder).viewForeground;
            }
            //Selected item
