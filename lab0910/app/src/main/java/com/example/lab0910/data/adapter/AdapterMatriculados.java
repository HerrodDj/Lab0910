...
public class AdapterMatriculados extends RecyclerView.Adapter<AdapterMatriculados.MyViewHolder> implements Filterable {

private ArrayList<Curso> cursosList;
private ArrayList<Curso> cursosListFiltered;
private Curso deletedItem;
private AdapterMatriculados.AdapterMatriculadosListener listener;
...
public class MyViewHolder extends RecyclerView.ViewHolder {
    ...
    public AdapterMatriculados(ArrayList<Curso> cursosList, AdapterMatriculados.AdapterMatriculadosListener listener) {
    ...
    @Override
    public AdapterMatriculados.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_list_row_desmat, parent, false);

        return new AdapterMatriculados.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(AdapterMatriculados.MyViewHolder holder, final int position) {
        // basically a render
...
public interface AdapterMatriculadosListener {
