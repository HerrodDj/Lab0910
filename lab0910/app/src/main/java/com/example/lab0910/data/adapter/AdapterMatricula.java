...
public class AdapterMatricula extends RecyclerView.Adapter<AdapterMatricula.MyViewHolder> implements Filterable {

    private ArrayList<Curso> cursosList;
    private ArrayList<Curso> cursosListFiltered;
    private Curso deletedItem;
    private AdapterMatricula.AdapterMatriculaListener listener;
    ...
    public AdapterMatricula(ArrayList<Curso> cursosList, AdapterMatricula.AdapterMatriculaListener listener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_list_row_mat, parent, false);
    ...
    public interface AdapterMatriculaListener {
