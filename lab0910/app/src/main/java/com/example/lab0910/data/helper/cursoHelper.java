...
public class cursoHelper extends ItemTouchHelper.SimpleCallback{
    ...
    public cursoHelper(int dragDirs, int swipeDirs, RecyclerItemTouchHelperListener listener) {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (viewHolder != null) {
            //check adapter
            if (this.listener.getClass().getSimpleName().equals("ListCurso")) {
